  ...
  init() {
    ...
    let defineProjection = function(projectionName, modelName, attributes) {
      function addSycPropertiesToProjection(proj, attrs) {
        attrs.createTime = FlexberryDS.attr('Creation Time', { hidden: true });
        attrs.creator = FlexberryDS.attr('Creator', { hidden: true });
        attrs.editTime = FlexberryDS.attr('Edit Time', { hidden: true });
        attrs.editor = FlexberryDS.attr('Editor', { hidden: true });
        attrs.syncDownTime = FlexberryDS.attr('SyncDown Time', { hidden: true });
        attrs.readOnly = FlexberryDS.attr('Read Only', { hidden: true });
